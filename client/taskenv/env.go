...
func (b *Builder) buildEnv(allocDir, localDir, secretsDir string,
	...
	if b.networkStatus != nil && b.allocatedPorts != nil {
		addNetNamespacePort(envMap, b.allocatedPorts, b.networkStatus)
	}
...
// addNetNamespacePort builds NOMAD_NET_NAMESPACE_{IP,PORT,ADDR}_{port_label}
// vars.
func addNetNamespacePort(envMap map[string]string, p structs.AllocatedPorts, netStatus *structs.AllocNetworkStatus) {
	for _, allocatedPort := range p {
		...
		envMap[AllocPrefix+"PORT_"+allocatedPort.Label] = portStr
